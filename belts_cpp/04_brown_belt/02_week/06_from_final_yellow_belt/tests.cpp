...
void TestDatabaseFromGithub() {
    ...
    // Add 2 - Del 1 - Add deleted again
    {
        ...
        db.Add(d, "e1");
        auto entries = db.FindIf(empty_predicate);
        AssertEqual(entries[0].second.size(), 2, "Db Add2-Del-Add 2"s);
    }
...
//        }
    ...
    // Find
    {
        ...
        AssertEqual(entries[0].second.size(), 2, "Db Find 1");
    }
    {
        Database db;
        db.Add({2019, 1, 1}, "e1");
...
void TestDateComparisonNode() {
    ...
    {
        DateComparison dcn(Comparison::Greater, {2017, 11, 18});
    ...
    {
        DateComparison dcn(Comparison::LessOrEqual, {2017, 11, 18});
    ...
    {
        DateComparison dcn(Comparison::GreaterOrEqual, {2017, 11, 18});
...
void TestEventComparisonNode() {
    ...
    {
        EventComparison ecn(Comparison::Greater, "abc");
    ...
    {
        EventComparison ecn(Comparison::LessOrEqual, "abc");
    ...
    {
        EventComparison ecn(Comparison::GreaterOrEqual, "abc");
...
void TestLogicalOperationNode() {
    {
        Logical lon(LogicalOperation::And, std::make_shared<Empty>(), std::make_shared<Empty>());
        Assert(lon.Evaluate(Date{0, 1, 1}, "abc"), "Logical 1");
    }
    {
        Logical lon(LogicalOperation::And, std::make_shared<AlwaysFalseNode>(),
                    std::make_shared<Empty>());
        Assert(!lon.Evaluate(Date{0, 1, 1}, "abc"), "Logical 2");
    }
    {
        Logical lon(LogicalOperation::And, std::make_shared<Empty>(),
                    std::make_shared<AlwaysFalseNode>());
        Assert(!lon.Evaluate(Date{0, 1, 1}, "abc"), "Logical 3");
    }
    {
        Logical lon(LogicalOperation::And, std::make_shared<AlwaysFalseNode>(),
                    std::make_shared<AlwaysFalseNode>());
        Assert(!lon.Evaluate(Date{0, 1, 1}, "abc"), "Logical 4");
    }
    {
        Logical lon(LogicalOperation::Or, std::make_shared<Empty>(), std::make_shared<Empty>());
        Assert(lon.Evaluate(Date{0, 1, 1}, "abc"), "Logical 5");
    }
    {
        Logical lon(LogicalOperation::Or, std::make_shared<AlwaysFalseNode>(),
                    std::make_shared<Empty>());
        Assert(lon.Evaluate(Date{0, 1, 1}, "abc"), "Logical 6");
    }
    {
        Logical lon(LogicalOperation::Or, std::make_shared<Empty>(),
                    std::make_shared<AlwaysFalseNode>());
        Assert(lon.Evaluate(Date{0, 1, 1}, "abc"), "Logical 7");
    }
    {
        Logical lon(LogicalOperation::Or, std::make_shared<AlwaysFalseNode>(),
                    std::make_shared<AlwaysFalseNode>());
        Assert(!lon.Evaluate(Date{0, 1, 1}, "abc"), "Logical 8");
    }
}
...
void TestEmptyNode() {
    {
        Empty en;
        Assert(en.Evaluate(Date{0, 1, 1}, "abc"), "Empty 1");
        Assert(en.Evaluate(Date{2017, 11, 18}, "def"), "Empty 2");
        Assert(en.Evaluate(Date{9999, 12, 31}, "ghi"), "Empty 3");
    }
}
