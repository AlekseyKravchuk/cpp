...
// Проверяет, содержится ли заданная точка в эллипсе заданного размера. Считается, что эллипс вписан в прямоугольник
// с вершинами в точках (0, 0) и (size.width, size.height)
...
// Изображение. Пиксели это символы. Первый индекс (по std::vector) - строки изображения, координата y.
...
public:
  ...
  // Возвращает точную копию фигуры. Если фигура содержит текстуру, то созданная копия содержит ту же самую текстуру.
  // Фигура и её копия совместно владеют этой текстурой.
