...
void TestComputeMedianAge() {
    ...
    { // Test odd number of element
        vector<Person> odd_number_of_elements = {Person{18, Gender::FEMALE, true}, Person{20, Gender::FEMALE, true},
                                                 Person{22, Gender::FEMALE, true}};
        ASSERT_EQUAL(ComputeMedianAge(begin(odd_number_of_elements), end(odd_number_of_elements)), 20);
    }
    { // Test odd number of element
        vector<Person> odd_not_sorted = {Person{20, Gender::FEMALE, true}, Person{18, Gender::FEMALE, true},
                                         Person{22, Gender::FEMALE, true}};
...
void TestReadPersons() {
    ...
    { // Test 2 element
        ...
        ASSERT_EQUAL(ReadPersons(two_element), (vector<Person>{{18, Gender::FEMALE, true},
...
void TestComputeStats() {
    ...
    { // Test 1 + 1 females
        ASSERT(age_stats_equal(
                ComputeStats(vector<Person>{{20, Gender::FEMALE, true},
                                            {22, Gender::FEMALE, false}}),
    ...
    { // Test 2 + 2 males and females
        ASSERT(age_stats_equal(
                ComputeStats(vector<Person>{{19, Gender::FEMALE, true},
                                            {18, Gender::FEMALE, false},
                                            {21, Gender::MALE,   true},
                                            {20, Gender::MALE,   false}}),
