...
class BusRoute {
  public:
    ...
    static BusRoute CreateOrdinaryBusRoute(BusRouteName bus_no, const std::vector<std::string>& stops);
    static BusRoute CreateRoundtripBusRoute(BusRouteName bus_no, const std::vector<std::string>& stops);
  private:
