...
class SuffixTree:
    ...
    def __init__(self, s, order, longest_common_prefix):
        self.s = s
        self.ele = ['$', 'A', 'C', 'G', 'T']
        self.order = order
        self.LCP = longest_common_prefix
    ...
    def suffix_tree_from_suffix_array(self):
        lcp_prev = 0
        cur = self.root
...
def main():
    ...
    suffix_tree.suffix_tree_from_suffix_array()
