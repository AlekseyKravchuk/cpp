/*
 * ECHO TCP-server with I/O multiplexing.
 * Server as a single process that uses select() to handle any number of clients, instead of forking one child per client.
 */
